CorrelationInstaller_mcr.exe
This file (Windows 64) will install the Mathworks MCR matlab emulator on your computer 

no internet connection is required. 
The CorrelationHeatMap.Exe will be then be extracted.
